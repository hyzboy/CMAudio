...
| 能力 | 实现 | 说明 |
|---|---|---|
| **解码插件体系** | `Plug-Ins/` 9 个 DLL | WAV / Vorbis / Opus + 6 个 MIDI 合成器（FluidSynth / WildMIDI / Timidity / ADLMIDI / OPNMIDI / TinySoundFont），扩展名→插件动态映射（`AudioDecode.cpp`） |
...
*本文档基于对 CMAudio 全模块的代码调研（inc/ 35 个头文件、src/ 34 个实现、Plug-Ins/ 9 个插件、examples/ 15 个示例）生成。*
